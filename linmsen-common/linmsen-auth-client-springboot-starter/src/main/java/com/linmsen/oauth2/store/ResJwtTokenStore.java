...
import com.linmsen.oauth2.constant.SecurityConstants;
import com.linmsen.oauth2.converter.CustomUserAuthenticationConverter;
...
@ConditionalOnProperty(prefix = "linmsen.oauth2.token.store", name = "type", havingValue = "db")
